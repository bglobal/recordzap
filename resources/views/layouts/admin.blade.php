        ...
        <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
            <div class="{{ config('bap.container-admin', 'container') }}">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/RecordZap-logo.png') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
                    </a>
                </h1>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item dropdown @if(\Illuminate\Support\Facades\Route::is('admin.order.*')) show @endif">
                            ...
                            <div class="dropdown-menu @if(\Illuminate\Support\Facades\Route::is('admin.order.*')) show @endif " data-bs-popper="none">
                                @can('admin_order_index')
                                <a class="dropdown-item @if(\Illuminate\Support\Facades\Route::is('admin.order.index')) active @endif" href="{{ route('admin.order.index') }}">
                                    {{ __('bap.orders') }}
                                </a>
                                @endcan
